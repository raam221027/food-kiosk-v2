...
// chart.js types a dataset as the union of every chart kind; both of these are lines.
...
const WidgetsDropdown = (props: WidgetsDropdownProps) => {
  ...
  useEffect(() => {
    document.documentElement.addEventListener('ColorSchemeChange', () => {
      ...
      if (chart1) {
        setTimeout(() => {
          ;(chart1.data.datasets[0] as LineDataset).pointBackgroundColor = getStyle('--cui-primary')
          chart1.update()
        })
      }
      ...
      if (chart2) {
        setTimeout(() => {
          ;(chart2.data.datasets[0] as LineDataset).pointBackgroundColor = getStyle('--cui-info')
          chart2.update()
        })
      }
    })
